...
--               c:/Users/jatin/Vivado_projects/Opensource/Opensource.gen/sources_1/ip/xadc_wiz_0_2/xadc_wiz_0_sim_netlist.vhdl
-- Design      : xadc_wiz_0
...
entity xadc_wiz_0_xadc_core_drp is
  port (
    ...
    alarm_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axis_tvalid : out STD_LOGIC;
    m_axis_tready : in STD_LOGIC;
    s_axis_aclk : in STD_LOGIC;
    m_axis_aclk : in STD_LOGIC;
...
XADC_INST: unisim.vcomponents.XADC
    generic map(
      ...
      ALM(2 downto 0) => alarm_out(2 downto 0),
      BUSY => busy_out,
...
begin
inst: entity work.xadc_wiz_0_axi_xadc
     port map (
